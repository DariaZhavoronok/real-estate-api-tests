import dto.request.AgentAddressDto;
import dto.request.AgentSearchRequestDto;
import dto.response.AgentsResponseDto;
...
public class SearchForAgentTests {
    ...
    public void userShouldBeAbleToSearchAnAgentByAddressTest() {
        ...
        final AgentSearchRequestDto searchRequest = getAgentsSearchRequest();
        ...
        final AgentsResponseDto actualSearchResponse = response.extract().as(AgentsResponseDto.class);
    ...
    private static void verifySearchResponse(final AgentsResponseDto response) {
    ...
    public static AgentSearchRequestDto getAgentsSearchRequest(){
        return AgentSearchRequestDto.builder()
